...
public class DatabaseElements extends AndroidTestBase {
	...
	public static MobileElement displayButton() {
		return driver.findElement(By.id("com.myapp.finance:id/ret"));
	}
	
	public static MobileElement description(int rowCount, int columnCount) {
		return driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.view.ViewGroup/android.widget.LinearLayout/android.widget.ScrollView/android.widget.TableLayout/android.widget.TableRow["+rowCount+"]/android.widget.EditText["+columnCount+"]"));
	}
	
	public static MobileElement amount(int rowCount, int columnCount) {
		return driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.view.ViewGroup/android.widget.LinearLayout/android.widget.ScrollView/android.widget.TableLayout/android.widget.TableRow["+rowCount+"]/android.widget.EditText["+columnCount+"]"));
	}
}
